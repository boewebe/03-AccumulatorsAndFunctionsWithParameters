...
#            The RENDER method allows the RoseWindow to display objects and shapes
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            It is necessary because otherwise the RoseWindow closes within a fraction of a second of opening.
#            This is because the code has been run.  The close_on_mouse_click method allows the code to pause.
#
